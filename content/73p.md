...
<div class="step-description">
    ...
    <p>If your 73P is not passing signal, first check your test setup by connecting the output of your interface directly to the input of your interface. Verify that you are getting 0dB gain (-10dBFS coming back to the Levels meter in REW). If this is working, check the mechanical connections to the sub-boards and X2. Make sure nothing is plugged into the DI jack and that the TRIM is set clockwise. Finally, check the placement and soldering in the OUTPUT section.</p>
</div>
