...
<div>
  ...
  <div class="step-header">Welcome to the 73P 1.0 assembly guide.</div>
  <div class="step-description">
	  ...
	  <p style="background-color:yellow;"><strong>This guide is for the 73P 1.0</strong>, which was last sold in June 2025. If you purchased your 73P after June 2025 use the <a href="https://manuals.diy.re/73p2">73P 1.1 Assembly Guide</a>.</p>
  </div>
</div>
...
<div class="manual-step">
    ...
    <div class="step-description">
        <p>To easily find parts and keep track of which ones you have populated, use the <a href="https://maps.diy.re/73p/" target="_blank">73P Interactive Build Map</a>.</p>
    </div>
</div>
...
<div class="step-description">
        ...
        <ol>
            ...
            <li>Probe the V+ test point with the red probe. The voltage should be within 24-26v. If you're doing this after installing the amplifier stages, the voltage will be closer to 21v.</li>
...
<div class="step-description">
        <p>Locate the rectangular transformer sub-board. Place the capacitor in the C39 position. This and the other silver capacitors in the kit are made from polystyrene. Polystyrene capacitors are not polarized, so they can be placed in either direction. However, they are very sensitive to heat. When soldering this and the other polystyrenes, heat the pad for a maximum of five seconds and wait 15 seconds before the soldering the next pad.</p> 
...
<p>R5/R71 sets the gain of the amplifier, which in its normal configuration is 18dB. At the 45 and 50dB gain settings, the GAIN switch adds resistors in parallel with R71 on PRE 2 to increase the gain to 23 and 28dB. PRE 1 has a fixed resistor, R4, added to set the gain to 30dB.</p>
...
<div class="step-description">
        <p>Install the two taller standoffs in the mounting holes that overlap the PRE 1 section and the shorter one in the hole next to CON2A. Then mount the sub-boards and screw them to the standoffs with the remaining black, pan-head screws. Put the black, nylon washers under the screws on the GAIN board. Do not install the nuts, front panel, or knobs yet.</p>
	<div class="part">
        <p>Pan-head screw (x3)</p>
        <img src="%base_url%/assets/parts/hw-s027.png">
    </div>
...
<div class="step-description">
    <p>Finally, we will go through each feature one-by-one to make sure your 73P is working perfectly.</p>
        <ol>
            ...
            <li><strong>Lo Z:</strong> Engage the Lo Z switch. The In level should increase by 3-6dB.</li>
            <li><strong>LN:</strong> Engage the LN switch. The In level should drop by ~25dB.</li>
			<li><strong>TRIM:</strong> Turn the knob completely in both directions. At fully CCW the In level should drop to about 80dB.</li>
