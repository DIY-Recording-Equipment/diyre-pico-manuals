    ...
    <p>Place the remaining capacitors in their respective places. As before, these capacitors are not polarized.</p>
     ...
     <div class="step-parts">
        <div class="part">
         ...
         <div class="part">
            <p>C6, C7, C8, C11<br>22p cap (x4)</p>
            <img src="%base_url%/assets/parts/com-c003.png">
        </div>
		<div class="part">
            <p>C10, C12<br>100p cap (x4)</p>
...
<div class="step-description">
    <p>If your unit powers up and passes audio fine, most likely it's functioning exactly as it should. But if you want to really be sure, follow the steps in this video to test your Duo with the free software Room Eq Wizard (REW) and your interface:</p>
...
<div class="manual-step">
    ...
    <li><a href="https://manuals.diy.re/docs/troubleshooting/product/colour-duo-troubleshooting/">Colour Duo troubleshooting guide</a></li>
    </ul>
