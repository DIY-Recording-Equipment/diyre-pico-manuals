...
<div class="step-description">
    <p>Place all 6 XLR jacks. Most will snap in place, but you may need to use some tape if they fall out before soldering. Solder the jacks but do not trim the leads.</p>
</div>
</div>
...
<div class="step-description">
        <p>Locate the CON2 and CON3 positions on the bottom of the motherboard. Place the shorter end of the right-angle headers in these positions with the longer pins facing out away from the PCB.. Then place the card edge boards over the longer pins so they protrude through CON3/4. Then fasten the card edge board to the motherboard with the black screws.</p>
</div>
</div>
...
<div class="manual-step">
    ...
    <li><a href="https://manuals.diy.re/docs/troubleshooting/product/pr502-troubleshooting/">PR502 troubleshooting guide</a></li>
    </ul>
