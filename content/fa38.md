...
<div class="manual-step">
    <div class="step-image">
    <a href="%base_url%/assets/fa38/fa38-sorting-1.1.pdf" target="_blank">
    <img src="%base_url%/assets/pdf-download.png" />
    </a>
    </div>
    <div class="step-description">
        <p>To identify and keep track of every part in the kit, download and print the <a href="%base_url%/assets/fa38/fa38-sorting-1.1.pdf" target="_blank">Component Sorting Sheet (PDF)</a>.</p>
    </div>
</div>
...
<div class="manual-step">
    ...
    <div class="step-description">
    <p>T5 is a transistor, not a capacitor or diode. But we placed it in this bag so that it would be impossible to mix up with the other silver-can transistor. Place the pins of the transistor through the nylon spacer. Then, place the 2N3019 in the T5 position, solder, and trim.</p>
    </div>
</div>
...
<h2>Transistors (Bag 4)</h2>
  ...
  <div class="manual-step">
    ...
    <div class="step-description">
    <p>Populate the remaining transistors. Put the nylon spacer on T6 before soldering. Note that the BC557s have a silver top, which corresponds to the filled-in transistor shapes on the PCB. Solder and trim.</p>
    </div>
  </div>
...
@[/checks/solder.html]
    ...
    <li><a href="https://manuals.diy.re/docs/troubleshooting/product/fa38-troubleshooting/">FA38 troubleshooting guide</a></li>
    </ul>
