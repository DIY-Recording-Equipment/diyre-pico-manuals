...
<div class="step-description">
    <ol>
		...
		<li>Choose and balanced, line-level output and input on your audio interface to use for testing. Connect these jacks directly with a balanced cable (do not connect the 73P).</li>
		<li>In REW, open Preferences and set the following options:
			<ul>
				<li>Drivers: ASIO (Windows only)</li>
				<li>Sample rate: 44.1kHz</li>
				<li>ASIO Device: Your audio interface</li>
				<li>Output: The output you will use for testing</li>
				<li>Input: The input you will use for testing</li>
		...
		<li>Close Preferences, open the Generator window and set these options:
			<ul>
				...
				<li>Lock frequency to RTA FFT: Check</li>
				<li>Level units (radio button): dBFS</li>
				<li>Level: -20dBFS</li>
				<li>You can ignore all other options.</p>
			</ul>
		</li>
		<li>Press the green play button. Then open the Levels window. The Out meter should read exactly -20.00 and the In meter should read very close to this (you can ignore the Ref In meter). If the In meter reads within +/-1dB of 20dBFS, REW is set up and you can skip the next step and proceed to 9.2.</li>
		<li>If the In meter does not read -20dBFS, check the following things:
			<ul>
				...
				<li>If the interface gain is set by the operating system, make sure these are set to the maximum level.</li>
				<li>If the In level is about 6dB too low, try a different balanced cable.</li>
				<li>Finally, after ruling out the other options, adjust the interface gain to compensate. Some interfaces (especially 2-channel ones) are not designed to have 0dB gain by default at the line input. Or, perhaps they do not have a line input at all so you must use a mic input. For these cases, set the output knob to the maximum level, and adjust the input gain until the Out meter in the REW Levels window reads -20dBFS.</li>
			</ul>
		</li>
	</ol>
</div>
