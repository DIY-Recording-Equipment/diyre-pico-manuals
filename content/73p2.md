...
<div>
  <div class="step-image">
    <a href="https://www.diyrecordingequipment.com/products/73p-class-a-mic-preamp">
             <img src="%base_url%/assets/73p2/73p-300.jpg">    	
    </a>
  </div>
...
<h2>Check Your PCB Revision</h2>
<div class="manual-step">
    <div class="step-image">
    <a href="%base_url%/assets/73p2/0-rev-check.jpg" target="_blank">
    <img src="%base_url%/assets/73p2/0-rev-check-600.jpg" />
    </a>
	</div>
	<div class="step-description">
    <p>Check the revision number in the upper-right of the main PCB. If yours says, v1.1, you are in the right place. If yours says v1.0, follow the <a href="https://manuals.diy.re/73p">73P v1.0 assembly guide</a>.</p>
</div>
...
<div class="manual-step">
    <div class="step-image">
    <a href="https://maps.diy.re/73p2/" target="_blank">
    <img src="%base_url%/assets/IBMicon.png" />
    </a>
    </div>
    <div class="step-description">
        <p>To easily find parts and keep track of which ones you have populated, use the <a href="https://maps.diy.re/73p2/" target="_blank">73P Interactive Build Map</a>.</p>
    </div>
</div>
...
<div class="manual-step">
    ...
    <div class="step-description">
        <p>Unlike other projects you may have built, the 73P does not have all the part values printed on the PCB. Where they are not specified, reference the parts list in that step of the guide and/or the Interactive Build Map.</p>
...
<div class="manual-step">
    <div class="step-image">
    <a href="%base_url%/assets/73p2/01-res-place.jpg" target="_blank">
    <img src="%base_url%/assets/73p2/01-res-place-600.jpg" />
    </a>
	</div>
...
<div class="manual-step">
    <div class="step-image">
    <a href="%base_url%/assets/73p2/01-res-solder.jpg" target="_blank">
    <img src="%base_url%/assets/73p2/01-res-solder-600.jpg" />
    </a>
    </div>
...
<div class="manual-step">
    <div class="step-image">
    <a href="%base_url%/assets/73p2/01-res-trim.jpg" target="_blank">
    <img src="%base_url%/assets/73p2/01-res-trim-600.jpg" />
    </a>
    </div>
    @[/mods/res-trim.html]
</div>
...
<div class="manual-step">
    <div class="step-image">
    <a href="%base_url%/assets/73p2/01-diodes.jpg" target="_blank">
    <img src="%base_url%/assets/73p2/01-diodes-600.jpg" />
    </a>
    </div>
    @[/mods/diodes.html]
        <div class="part">
        ...
        <div class="part">
			...
			<p>Markings: 1N4 739 A</p>
        </div>
</div>

<div class="manual-step">
    <div class="step-image">
    <a href="%base_url%/assets/73p2/01-caps-small.jpg" target="_blank">
    <img src="%base_url%/assets/73p2/01-caps-small-600.jpg" />
    </a>
    </div>
    <h3 class="step-header">Populate Small Capacitors, Transistor, and Fuse</h3>
    <div class="step-description">
        <p>Place T10 so that it's orientation matches the shape on the PCB. The smaller capacitors and fuse not polarized and therefore can be placed in either direction. Solder then trim the leads.</p>
        </div>
        <div class="part">
            <p>C25<br>.01u cap</p>
		...
		<div class="part">
            <p>T10<br>ZVP2106A transistor</p>
...
<div class="manual-step">
    <div class="step-image">
    <a href="%base_url%/assets/73p2/01-caps-large.jpg" target="_blank">
    <img src="%base_url%/assets/73p2/01-caps-large-600.jpg" />
    </a>
    </div>
    @[/mods/caps-large.html]
        <div class="part">
            <p>C11, C27<br>470u cap (x2)</p>
...
<div class="manual-step">
    <div class="step-image">
    <a href="%base_url%/assets/73p2/01-trs-jack.jpg" target="_blank">
    <img src="%base_url%/assets/73p2/01-trs-jack-600.jpg" />
    </a>
    </div>
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/01-led-place.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/01-led-place-600.jpg" />
        </a>
    </div>
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/01-led-solder.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/01-led-solder-600.jpg" />
        </a>
    </div>
    <h3 class="step-header">Solder 48v LED</h3>
<div class="step-description">
        <p>Next we'll ensure the alignment of the LED by putting on the front panel. Place the PCB in the bracket and fasten it with at least two screws from bag 8.1. Attach the front panel with the washer and nut of J1. Confirm that LED1 is sitting flush with the front panel, then solder and trim the leads close to the solder joint. Then remove the front panel, take the PCB out of the bracket, and put the screws back in bag 8.1. Set the washer and nut for J1 aside until step 8.3.</p>
</div>
</div>

<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/01-switches.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/01-switches-600.jpg" />
        </a>
    </div>
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/01-relay.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/01-relay-600.jpg" />
        </a>
    </div>
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/01-headers.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/01-headers-600.jpg" />
        </a>
    </div>
    <h3 class="step-header">Populate Header and Socket</h3>
        ...
        <ol>
            ...
            <p>For the X2 header, make sure the plastic tab aligns with the line on the PCB.</p>
        </div>
        <div class="part">
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/01-heatsink-solder.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/01-heatsink-solder-600.jpg" />
        </a>
    </div>
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/01-test.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/01-test-600.jpg" />
        </a>
    </div>
...
<div class="step-description">
        ...
        <ol>
            ...
            <li>Probe the V+ test point with the red probe. The voltage should be within 24-26v (the voltage will drop closer to 24v after the amplifier circuits are added).</li>
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/02-components.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/02-components-600.jpg" />
        </a>
    </div>
    <h3 class="step-header">Populate Other Components</h3>
<div class="step-description">
        <p>Populate the diode, transistors, capacitors, and relay. The diode, electrolytic capacitors, tantalum capacitors, transistors, and relay are polarized. On the tantalums the positive lead is longer and marked with a "+". Orient the transistors according to the outlines on the PCB. Also note that the two transistors are different. T5 is silver on top and the footprint on the PCB is filled in.</p>
</div>
    <div class="part">
    ...
    <div class="part">
        <p>C13, C14<br>22u tantalum cap (x2)</p>
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/03-header.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/03-header-600.jpg" />
        </a>
    </div>
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/03-transformer.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/03-transformer-600.jpg" />
        </a>
    </div>
    <h3 class="step-header">Place Input Transformer</h3>
<div class="step-description">
        <p>Remove and discard the two screws from the brown side of the VTB9045 transformer next to the pins.</p>
        <p>Place the transformer on the opposite side of the board from C39 and X1B. Pay close attention to the pin numbers printed on the transformer and on the PCB. Double check that they are aligned before soldering. It <em>is</em> possible to put the transformer in backwards. And if you do it's difficult to remove and expensive to replace.</p>
        <p>Attach the board to the transformer with the two black screws. This will require a bit of force, as the screws are cutting the threads. If the board starts to bend, back them off a bit. Then solder and trim the transformer pins.</p>
    <div class="part">
        <p>Transformer screw (x2)</p>
        <img src="%base_url%/assets/parts/hw-s027.png">
    </div>
	<div class="part">
        <p>XC1<br>VTB9045 transformer</p>
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/03-transformer-place.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/03-transformer-place-600.jpg" />
        </a>
    </div>
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/04-resistors.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/04-resistors-600.jpg" />
        </a>
    </div>
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/04-rotary.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/04-rotary-600.jpg" />
        </a>
    </div>
...
<div class="step-description">
        ...
        <p>Remove the plastic covers from the rows of pins. Place the rotary switch in the larger notch in the front of the bracket with the pins facing up. Fasten the switch to the bracket with the nut. Discard the lock washer. Place the GAIN board over the pins of the switch so that the side that says, "All parts other side!" is visible.</p>
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/04-header.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/04-header-600.jpg" />
        </a>
    </div>
    <h3 class="step-header">Place Header</h3>
<div class="step-description">
        <p>Place the side with shorter pins in the CON1B position on the same side of the board as the switch and the rest of the components. The long pins should face up and reach to just about the top of the switch. Double check that the header is on the correct side of the board, then solder.</p>
    <div class="part">
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/04-test.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/04-test-600.jpg" />
        </a>
    </div>
...
<div class="step-description">
        <ol>
            ...
            <li>Put the black probe on TP1 and the red probe on TP2. Now check the resistance at each position. They should be within 10% of these values:
				<ul>
            ...
            <li>Now move the red probe to TP3 and check the remaining positions:
				<ul>
					<li>9: 2.7k</li>
					<li>10: 5.4k</li>
					<li>11: 8.7k</li>
...
<p>The PRE 1 and PRE 2 sections are the amplifiers that provide the lion's share of the 73P's gain. Both are essentially the same circuit. The only differences between the two are the values of the feedback (R1 and R66) and PRE 1 has an extra resistor, R4 to increase the gain.</p>
<p>The PRE 1 and PRE 2 amplifiers each consist of just three transistors. T1/T12 and T3/T11 amplify the voltage, while T2/T13 is an output buffer that amplifies the current. The capacitors C9/C33 and C10/C37 AC-couple the input and output, preventing DC from entering or leaving the circuit. The rest of the components act to set the bias points of the transistors, and keep them stable with lots of feedback and filtering.</p>
<p>R5/R74 sets the gain of the amplifier, which in its normal configuration is 18dB. At the 45 and 50dB gain settings, the GAIN switch adds resistors in parallel with R74 on PRE 2 to increase the gain to 23 and 28dB. PRE 1 has a fixed resistor, R4, added to set the gain to 30dB.</p>

<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/05-resistors.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/05-resistors-600.jpg" />
        </a>
    </div>
    <h3 class="step-header">Populate Resistors</h3>
<div class="step-description">
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/05-transistors.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/05-transistors-600.jpg" />
        </a>
    </div>
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/05-caps.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/05-caps-600.jpg" />
        </a>
    </div>
...
<div class="step-description">
        ...
        <div class="part">
            <p>C7<br>680p cap</p>
            <img src="%base_url%/assets/parts/com-088.png">
            <p>Markings: WIMA 680/63</p>
        </div>
        <div class="part">
            <p>C8<br>1000p cap</p>
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/05-socket.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/05-socket-600.jpg" />
        </a>
    </div>
...
<p>In addition to the amplifier circuitry described in the previous section, the PRE 2 block contains the output trim control. VR2 is the output trim potentiometer on the front panel. VR3 is a trimpot for finely matching gain between two units.</p>

<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/06-resistors.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/06-resistors-600.jpg" />
        </a>
    </div>
    <h3 class="step-header">Populate Resistors</h3>
<div class="step-description">
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/06-components.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/06-components-600.jpg" />
        </a>
    </div>
    <h3 class="step-header">Populate Components</h3>
<div class="step-description">
        <p>Populate the other components, except for the potentiometer VR3 and header CON2B. As you did in the last section, pay close attention to the polarity of the transistors and polarized capacitors. Remember to put the spacers on the transistors before soldering. The trimpot VR2 should also be placed according to the outline on the PCB.</p>
        <div class="part">
            <p>T11-T13<br>BC109C transistor (x3)</p>
            <img src="%base_url%/assets/parts/com-t020.png">
        </div>
        <div class="part">
            <p>T11-T13<br>Transistor spacer (x3)</p>
            <img src="%base_url%/assets/parts/com-z015.png">
        </div>
        <div class="part">
            <p>C30<br>680p cap</p>
        ...
        <div class="part">
            <p>C33, C35, C37<br>22u tantalum cap (x3)</p>
            <img src="%base_url%/assets/parts/com-c047.png">
			<p>Markings: 226F</p>
        </div>
        <div class="part">
        ...
        <div class="part">
            <p>C36<br>1500p cap</p>
            <img src="%base_url%/assets/parts/com-c090.png">
            <p>Markings: WIMA 1500</p>
        </div>
        <div class="part">
            <p>C38<br>1000p cap</p>
            <img src="%base_url%/assets/parts/com-c025.png">
            <p>Markings: 1n</p>
        </div>
        <div class="part">
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/06-pot.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/06-pot-600.jpg" />
        </a>
    </div>
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/06-header.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/06-header-600.jpg" />
        </a>
    </div>
    <h3 class="step-header">Place Header</h3>
<div class="step-description">
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/07-resistors.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/07-resistors-600.jpg" />
        </a>
    </div>
    <h3 class="step-header">Populate Resistors</h3>
<div class="step-description">
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/07-components.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/07-components-600.jpg" />
        </a>
    </div>
    <h3 class="step-header">Populate Components</h3>
<div class="step-description">
        ...
        <div class="part">
            <p>C17<br>22u tantalum cap</p>
            <img src="%base_url%/assets/parts/com-c047.png">
			<p>Markings: 226F</p>
        </div>
        <div class="part">
            <p>C18, C20, C23, C24<br>100u cap (x4)</p>
            <img src="%base_url%/assets/parts/com-c022.png">
        </div>
        <div class="part">
            <p>C19<br>330p cap</p>
            <img src="%base_url%/assets/parts/com-c089.png">
            <p>Markings: WIMA 330/63</p>
        </div>
        <div class="part">
            <p>C21<br>4700p cap</p>
            <img src="%base_url%/assets/parts/com-c062.png">
            <p>Markings: WIMA 4700 100</p>
        </div>
        <div class="part">
            <p>C22<br>220p cap</p>
            <img src="%base_url%/assets/parts/com-c063.png">
            <p>Markings: WIMA 220 100</p>
        </div>
        <div class="part">
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/07-transformer.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/07-transformer-600.jpg" />
        </a>
    </div>
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/07-transformer1.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/07-transformer1-600.jpg" />
        </a>
    </div>
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/08-mb.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/08-mb-600.jpg" />
        </a>
    </div>
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/08-output-xfmr.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/08-output-xfmr-600.jpg" />
        </a>
    </div>
    <h3 class="step-header">Mount Output Transformer</h3>
<div class="step-description">
        <p>Place the transformer in the gap in the motherboard with the side with the pins 7, 5, 6, 8 facing up. Fasten it to the bracket with the larger, silver screws and nuts from bag 8.1, then plug the wire assembly into the X2 header.</p>
    <div class="part">
    <p>Transformer screw (x2)</p>
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/08-switch-caps.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/08-switch-caps-600.jpg" />
        </a>
    </div>
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/08-sub.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/08-sub-600.jpg" />
        </a>
    </div>
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/08-frontpanel.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/08-frontpanel-600.jpg" />
        </a>
    </div>
...
<div class="manual-step">
 <div class="step-video">
    ...
    <h3 class="step-header">Set Up Room EQ Wizard (REW)</h3>
<div class="step-description">
    <ol>
		<li>Download and install REW from the <a href="https://www.roomeqwizard.com/">Room EQ Wizard website</a>.</li>
		<li>Choose a balanced, line-level input and output on your audio interface. Connect these jacks to each other with a balanced cable (do not connect the 73P).</li>
		<li>In REW, open Preferences and set the following options:
			<ul>
				<li>Drivers: ASIO (Windows only)</li>
				<li>Device: Your audio interface</li>
				<li>Sample rate: 44.1kHz</li>
				<li>Output: The output you connected in step 2</li>
				<li>Input: The input you connected in step 2</li>
				<li>Secondary output: Uncheck</li>
				<li>You can ignore all other options such as Timing reference output, Sweep level, etc.</p>
			</ul>
		</li>
		<li>Close Preferences, open the Generator window and set these options:
			<ul>
				<li>Tones (very top-left button)</li>
				<li>Sine</li>
				<li>Frequency Hz: 1,000</li>
				<li>Level units (radio button): dBFS</li>
				<li>Level: -20dBFS</li>
				<li>You can ignore all other options.</p>
			</ul>
		</li>
		<li>Press the green play button. Then open the Levels window. The Out meter should read exactly -20dbFS and the In meter should read very close to this (you can ignore the Ref In meter). If the In meter reads within +/-1dB of -20dBFS, REW is set up and you can skip the next step and proceed to 9.2.</li>
		<li>If the In meter does not read -20dBFS, check the following things:
			<ul>
				<li>If the output or input gain is set by your interface drivers or control software, make sure they are set to 0dB.</li>
				<li>If the interface gain is set by the operating system, make sure it is set to the maximum level.</li>
				<li>If the In level is about 6dB too low, you may have a bad cable. Try setup again with a different balanced cable.</li>
				<li>Finally, after ruling out the other options, adjust the interface gain to compensate. Some interfaces (especially 2-channel ones) are not designed to have 0dB gain by default at the line input. Others do not have a line input at all so you must use a mic input. For these cases, set the output knob to the maximum level, and adjust the input gain until the In meter in the REW Levels window reads -20dBFS.</li>
			</ul>
		</li>
	</ol>
</div>
...
<div class="manual-step">
 <div class="step-video">
    ...
    <h3 class="step-header">Calibrate Output Transistor</h3>
    <div class="step-description">
        <p>In this step we will set the bias of T8 for the highest headroom possible. Before starting this test, power up the 73P and let it sit for at least 15 minutes. This gives the transistors time to reach their normal operating temperatures.</p>
        <ol>
            <li>Set your multi-meter to read DC volts. (If your meter has multiple DC ranges, set it to 20v DC).</li>
            <li>Probe both of the BIAS test points in the OUTPUT section. It does not matter which probe goes on which side.</li>
            <li>Trim VR1 until the meter shows 2.5VDC (or -2.5VDC depending on which way you have placed the probes).</li>
        </ol>
    </div>
</div>
...
<div class="step-description">
    <p>Finally, we will go through each feature one-by-one to make sure your 73P is working perfectly.</p>
        <ol>
			...
			<li><strong>TRIM:</strong> Turn the knob completely in both directions. At fully CCW the In level should drop about 80dB.</li>
            <li><strong>Gain:</strong> Set the Generator to -65dFS and the 73P gain to 55dB. The In level should be about -10dBFS.</li>
        </ol>
...
<div class="manual-step">
    <div class="step-image">
        <a href="%base_url%/assets/73p2/finished.jpg" target="_blank">
        <img src="%base_url%/assets/73p2/finished-600.jpg" />
        </a>
    </div>
    @[/mods/finished.html]
</div>
