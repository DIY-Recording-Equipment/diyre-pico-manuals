...
<div>
  ...
  <div class="step-header">Welcome to the 73P 1.1 assembly guide.</div>
  <div class="step-description">
      <p>Thank you for purchasing a <a href="https://www.diyrecordingequipment.com/products/73p-class-a-mic-preamp">73P</a>.</p>
...
<h2><span style="background-color: yellow;padding: 5px;">Important: Check PCB Revision</span></h2>
...
<div class="manual-step">
	...
	<p><span style="font-weight: bold;background: yellow;">Important:</span> Before continuing, double check that you are following the correct guide. Check the revision number in the upper-right of the main PCB. If yours says, v1.1, you are in the right place. If yours says v1.0, follow the <a href="https://manuals.diy.re/73p">73P v1.0 assembly guide</a>.</p>
</div>
...
<div class="manual-step">
    ...
    @[/mods/diodes.html]
        <div class="part">
            <p>D2<br>1N400x diode</p>
            <img src="%base_url%/assets/parts/com-d005.png">
			<p>Markings: 1N4001 or 1N4004</p>
        </div>
        <div class="part">
...
<div class="step-description">
        ...
        <ol>
            ...
            <li>Probe the V+ test point with the red probe. The voltage should be within 24-26v.</li>
            <li>Engage the 48 switch (3rd from the top). LED1 should illuminate.</li>
        </ol>
        <p>Did your 73P pass the first test? Great! Proceed with confidence. If not, double check your solder joints, the resistor values, and the orientation of D3. If you're doing this after installing the amplifier stages, the voltage will be around 21v. If these are all correct, please contact us via the "Help" button below.</p>
</div>
</div>
...
<div class="step-description">
        <p>Locate the rectangular transformer sub-board. Place the capacitor in the C40 position. This and the other film capacitors are not polarized, so they can be placed in either direction.</p> 
...
<div class="step-description">
        <ol>
            <li>To make this step easier with two hands, attach the large knob from bag 8.2 to the GAIN switch. Use a flat head screwdriver to tighten the set screw on the knob. The position of the knob pointer doesn't matter for now.</li>
...
<div class="manual-step">
    ...
    <h3 class="step-header">Populate Resistors</h3>
<div class="step-description">
        <p>Populate the resistors in the OUTPUT section on the motherboard.</p>
    <table class="res-sort">
    <thead>
      <tr>
        <th>Reference<br></th>
...
<div class="step-description">
        <p>Begin by tinning the ends of the black hookup wire. Do this by heating the exposed wire and then adding a bit of solder. Wrap the ends of the wire around pins 6 and 7 of the transformer. Heat the pin and wire for about five seconds, then add solder.</p>
...
<div class="step-description">
        ...
        <p></p>
        <p>Solder the wiring harness to the transformer according to the chart below. Wire 1 of the wiring harness is red, wire 2 is next to wire 1, etc.</p>
        <table>
            <thead>
              <tr>
                <th>Harness Wire</th>
...
<div class="step-description">
    <p>The first test is very simple, we are just going to make sure the 73P is passing signal from input to output.</p>
        <ol>
            ...
            <li>From the REW Generator send a 1kHz, -10dBFS signal.</li>
 ...
 <div class="step-video">
    ...
    <div class="step-description">
        ...
        <ol>
            ...
            <li>Probe the B1 and B2 test points in the OUTPUT section. It does not matter which probe goes on which side.</li>
...
<div class="step-description">
    <p>Finally, we will go through each feature one-by-one to make sure your 73P is working perfectly.</p>
        <ol>
			...
			<li><strong>TRIM:</strong> Turn the knob completely in both directions. The level should go down as you turn the knob CCW.</li>
...
<div class="manual-step">
    ...
    <li><a href="https://manuals.diy.re/docs/troubleshooting/product/73p-troubleshooting/">73P troubleshooting guide</a></li>
    </ul>
