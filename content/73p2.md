---
Title: 73P Assembly Guide v1.13
Date: [date]
Template: manual
---
...
<div class="manual-step">
	...
	<div class="step-description">
    <p>Check the revision number in the upper-right of the main PCB. If yours says, v1.13, you are in the right place. If yours says v1.0, follow the <a href="https://manuals.diy.re/73p">73P v1.0 assembly guide</a>.</p>
</div>
...
<div class="step-description">
    ...
    <p>If your 73P is not returning -10dBFS, first check your test setup. Do this by connecting the output of your interface directly to the input of your interface with an XLR cable (skipping the 73P). Verify that you are getting 0dB gain; that is, -10dBFS should be coming back to the Levels meter in REW. If this is working, check the mechanical connections to the sub-boards and X2. Make sure nothing is plugged into the DI jack and that the TRIM is set clockwise. Finally, check the placement and soldering in the OUTPUT section.</p>
</div>
